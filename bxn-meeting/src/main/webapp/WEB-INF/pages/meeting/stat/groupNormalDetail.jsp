...
<body width="95%">
	<div class="data-table" id="table_fixed_container">
		<div class="head">${meetingGroup.groupName }全勤名单</div>
		<form id="query-form">
    ...
    $(function(){
        ...
        $("#gobackBtn").click(function(){
            window.location.href="${ctx}/meeting/stat/group/detailPage/${meetingGroup.id}?beginDate="+beginDate + "&endDate="+endDate  + "&meetingTypeId="+meetingTypeId;
        });
    	
     	// 导出
        $("#normalexportBtn").click(function(){
        	window.location.href="${ctx}/webapi/meeting/v1/stat-group-normal-export/${meetingGroup.id}?beginDate="+beginDate + "&endDate="+endDate  + "&meetingTypeId="+meetingTypeId;
        });
